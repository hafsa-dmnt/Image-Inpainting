...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_path', type=str, default='/home/hdemnati/904/test_nonofficial/DMFN/CelebAMask-HQ/CelebA-HQ-img', help='the file storing training image paths')
        self.parser.add_argument('--data_file', type=str, default='/home/hdemnati/904/test_nonofficial/DMFN/CelebA_txt/train.txt', help='the file storing training image paths')
    ...
    def parse(self):
        ...
        # self.opt.dataset_path = os.path.join(self.opt.data_file, 'train.txt')
